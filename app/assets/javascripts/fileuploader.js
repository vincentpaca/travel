...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        uploadButtonText: 'Add a photo',
        cancelButtonText: 'Cancel',
        failUploadText: 'Upload failed',

        template: '<div class="qq-uploader">' +
            (!this._options.disableDefaultDropzone ? '<div class="qq-upload-drop-area"><span>{dragText}</span></div>' : '') +
            (!this._options.button ? '<div class="qq-upload-button"><i class="icon-camera"></i> {uploadButtonText}</div>' : '') +
        ...
        extraMessages: {
            ...
            tooManyFilesError: "You may only upload one file"
        },
